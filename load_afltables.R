...
afltables <- afltables %>% 
    mutate(
        ...
        playing_for_short = case_when(
            ...
            playing_for == 'North Melbourne' ~ 'NMFC',
            playing_for == 'Richmond' ~ 'RICH',
            playing_for == 'Brisbane Bears' ~ 'BB',
            playing_for == 'Fremantle' ~ 'FRE',
            playing_for == 'Brisbane Lions' ~ 'BL',
            playing_for == 'Port Adelaide' ~ 'PORT',
            playing_for == 'Gold Coast' ~ 'GCFC',
        ...
        opp_short = case_when(
            ...
            opp == 'Melbourne' ~ 'MELB',
            opp == 'St Kilda' ~ 'STK',
            opp == 'Collingwood' ~ 'COLL',
            opp == 'Adelaide' ~ 'ADEL',
            opp == 'Hawthorn' ~ 'HAW',
            opp == 'West Coast' ~ 'WCE',
            opp == 'Western Bulldogs' ~ 'WB',
            opp == 'North Melbourne' ~ 'NMFC',
            opp == 'Richmond' ~ 'RICH',
            opp == 'Brisbane Bears' ~ 'BB',
            opp == 'Fremantle' ~ 'FRE',
            opp == 'Brisbane Lions' ~ 'BL',
            opp == 'Port Adelaide' ~ 'PORT',
            opp == 'Gold Coast' ~ 'GCFC',
            opp == 'Greater Western Sydney' ~ 'GWS',
            opp == 'University' ~ 'UNI',
            T ~ opp
        ),
        w_l = case_when(
